# https://lab.magiconch.com/kumikos/
import os
import requests
...
#     pic = soup.find_all('div', attrs={'class':'item'})
#     pic_list = []
#     for link in pic:
...
def main():
    ...
    os.makedirs('D:\pic\kumikos', exist_ok=True) 
    for i in const_imageURLs:
        file_name = i + '.jpg'
        file_path = 'D:\pic\kumikos' + file_name
        url='https://'+i+'.jpg'
